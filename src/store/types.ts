...
// Create interface for task and list
...
// Actions - Create interface to store actions
...
// Create union types from action interfaces
...
// Create list interface for list state and 
// notification interface for notification state
